...
public class ModEffects {
    ...
    public static final RegistryObject<MobEffect> TUTORIALLIUM_EFFECT = EFFECTS.register("tutoriallium_effect", () -> new TutorialliumEffect(MobEffectCategory.BENEFICIAL, 1));
